...
public final class MobData {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard(SQUID, MobDataTier.PASSIVE, new ItemStack[] {
                new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.INK_SAC, 32), new ItemStack(Material.KELP, 64),
                new ItemStack(Material.GLOW_INK_SAC, 32), EMPTY_DATA_CARD, new ItemStack(Material.GLOW_INK_SAC, 32),
                new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.INK_SAC, 32), new ItemStack(Material.KELP, 64)
        }).addDrop(Material.INK_SAC, 1).register(plugin);
        ...
        new MobDataCard(BEE, MobDataTier.NEUTRAL, new ItemStack[] {
                ...
                new ItemStack(Material.HONEYCOMB_BLOCK, 16), new ItemStack(Material.HONEY_BLOCK, 16), new ItemStack(Material.HONEYCOMB_BLOCK, 16)
        }).addDrop(Material.HONEYCOMB, 1).addDrop(Material.HONEY_BOTTLE, 1).register(plugin);
